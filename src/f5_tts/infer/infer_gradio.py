...
def load_f5tts(ckpt_path=str(cached_path("hf://SWivid/F5-TTS/F5TTS_Base/model_1200000.safetensors", cache_dir=".models"))):
    F5TTS_model_cfg = dict(dim=1024, depth=22, heads=16, ff_mult=2, text_dim=512, conv_layers=4)
    return load_model(DiT, F5TTS_model_cfg, ckpt_path)


def load_e2tts(ckpt_path=str(cached_path("hf://SWivid/E2-TTS/E2TTS_Base/model_1200000.safetensors", cache_dir=".models"))):
...
def load_custom(ckpt_path: str, vocab_path="", model_cfg=None):
    ...
    if ckpt_path.startswith("hf://"):
        ckpt_path = str(cached_path(ckpt_path, cache_dir=".models"))
    if vocab_path.startswith("hf://"):
        vocab_path = str(cached_path(vocab_path, cache_dir=".models"))
